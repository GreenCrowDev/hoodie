...
public:
	...
	explicit Handle(IndexType idx = PMP_MAX_INDEX) :
			idx_(idx) {}
...
public:
	...
	explicit VertexProperty(Property<T> p) :
			Property<T>(p) {}
...
public:
	...
	explicit HalfedgeProperty(Property<T> p) :
			Property<T>(p) {}
...
public:
	...
	explicit EdgeProperty(Property<T> p) :
			Property<T>(p) {}
...
public:
	...
	explicit FaceProperty(Property<T> p) :
			Property<T>(p) {}
